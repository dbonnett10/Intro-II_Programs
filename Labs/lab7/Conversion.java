...
public class Conversion {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("The answer to the postfix equation is: " + postIn(output));
        System.out.println("");
        String post;
        System.out.println("Enter a postfix equation");
        post = scan.nextLine();
        System.out.println("The solution is: " + postIn(post));

    } //main

    //Calculator part for lab7 starts here
    public static double postIn(String post) {
        StackDouble t = new StackDouble(25);
        double solution = 0;

        for (int k = 0; k < post.length(); k++) {
            char currChar = post.charAt(k);
            if (currChar == '+') {
                double a = t.pop();
                double b = t.pop();
                solution = a + b;
